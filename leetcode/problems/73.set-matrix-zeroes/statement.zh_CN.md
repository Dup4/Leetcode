...
??? info "Metadata"
    - Link: [矩阵置零](https://leetcode-cn.com/problems/set-matrix-zeroes)
    - Difficulty: Medium
    - Tag: `数组` `哈希表` `矩阵`
...
<img alt="" src="problem-assets/https:--assets.leetcode.com-uploads-2020-08-17-mat1.jpg" style="width: 450px; height: 169px;" />
<pre>
...
<img alt="" src="problem-assets/https:--assets.leetcode.com-uploads-2020-08-17-mat2.jpg" style="width: 450px; height: 137px;" />
<pre>
