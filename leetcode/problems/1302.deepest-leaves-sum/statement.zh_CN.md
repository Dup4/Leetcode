...
??? info "Metadata"
    - Link: [层数最深叶子节点的和](https://leetcode-cn.com/problems/deepest-leaves-sum)
    - Difficulty: Medium
...
<p><strong><img alt="" src="problem-assets/https:--assets.leetcode-cn.com-aliyun-lc-upload-uploads-2019-12-28-1483_ex1.png" style="height: 265px; width: 273px;" /></strong></p>
