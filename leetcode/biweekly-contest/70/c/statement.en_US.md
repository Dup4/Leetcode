...
??? info "Metadata"
    - Link: [K Highest Ranked Items Within a Price Range](https://leetcode.com/problems/k-highest-ranked-items-within-a-price-range)
    - Difficulty: Medium
    - Tag: `Breadth-First Search` `Array` `Matrix` `Sorting` `Heap (Priority Queue)`
