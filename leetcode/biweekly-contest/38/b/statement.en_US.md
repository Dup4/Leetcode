...
??? info "Metadata"
    - Link: [Widest Vertical Area Between Two Points Containing No Points](https://leetcode.com/problems/widest-vertical-area-between-two-points-containing-no-points)
    - Difficulty: Medium
    - Tag: `Array` `Sorting`
