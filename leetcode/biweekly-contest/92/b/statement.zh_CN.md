...
??? info "Metadata"
    - Link: [行和列中一和零的差值](https://leetcode.cn/problems/difference-between-ones-and-zeros-in-row-and-column)
    - Difficulty: Medium
    - Tag: 
...
<p><img src="problem-assets/https:--assets.leetcode.com-uploads-2022-11-06-image-20221106171729-5.png" style="width: 400px; height: 208px;"></p>
...
<p><img src="problem-assets/https:--assets.leetcode.com-uploads-2022-11-06-image-20221106171747-6.png" style="width: 358px; height: 150px;"></p>
