...
??? info "Metadata"
    - Link: [Shortest Subarray to be Removed to Make Array Sorted](https://leetcode.com/problems/shortest-subarray-to-be-removed-to-make-array-sorted)
    - Difficulty: Medium
    - Tag: `Stack` `Array` `Two Pointers` `Binary Search` `Monotonic Stack`
