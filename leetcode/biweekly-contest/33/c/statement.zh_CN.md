...
??? info "Metadata"
    - Link: [得到目标数组的最少函数调用次数](https://leetcode-cn.com/problems/minimum-numbers-of-function-calls-to-make-target-array)
    - Difficulty: Medium
    - Tag: `贪心` `数组`

<p><img alt="" src="problem-assets/https:--assets.leetcode.com-uploads-2020-07-10-sample_2_1887.png" style="height:294px; width:573px" /></p>
