...
??? info "Metadata"
    - Link: [从链表中移除节点](https://leetcode.cn/problems/remove-nodes-from-linked-list)
    - Difficulty: Medium
    - Tag: 
...
<p><img alt="" src="problem-assets/https:--assets.leetcode.com-uploads-2022-10-02-drawio.png" style="width: 631px; height: 51px;" /></p>
