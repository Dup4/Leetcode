...
??? info "Metadata"
    - Link: [Remove Nodes From Linked List](https://leetcode.com/problems/remove-nodes-from-linked-list)
    - Difficulty: Medium
    - Tag: 
...
<img alt="" src="problem-assets/https:--assets.leetcode.com-uploads-2022-10-02-drawio.png" style="width: 631px; height: 51px;" />
<pre>
