...
??? info "Metadata"
    - Link: [Minimum Cost to Connect Two Groups of Points](https://leetcode.com/problems/minimum-cost-to-connect-two-groups-of-points)
    - Difficulty: Hard
    - Tag: `Bit Manipulation` `Array` `Dynamic Programming` `Bitmask` `Matrix`
