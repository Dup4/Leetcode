...
??? info "Metadata"
    - Link: [Count Subtrees With Max Distance Between Cities](https://leetcode.com/problems/count-subtrees-with-max-distance-between-cities)
    - Difficulty: Hard
    - Tag: `Bit Manipulation` `Tree` `Dynamic Programming` `Bitmask` `Enumeration`
...
<p><strong><img alt="" src="problem-assets/https:--assets.leetcode.com-uploads-2020-09-21-p1.png" style="width: 161px; height: 181px;" /></strong></p>
