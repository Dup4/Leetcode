...
??? info "Metadata"
    - Link: [Find Substring With Given Hash Value](https://leetcode.com/problems/find-substring-with-given-hash-value)
    - Difficulty: Medium
    - Tag: `String` `Sliding Window` `Hash Function` `Rolling Hash`
