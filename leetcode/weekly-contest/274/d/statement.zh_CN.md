...
??? info "Metadata"
    - Link: [参加会议的最多员工数](https://leetcode-cn.com/problems/maximum-employees-to-be-invited-to-a-meeting)
    - Difficulty: Hard
    - Tag: `深度优先搜索` `图` `拓扑排序`
...
<p><img alt="" src="problem-assets/https:--assets.leetcode.com-uploads-2021-12-14-ex1.png" style="width: 236px; height: 195px;"></p>
...
<p><img alt="" src="problem-assets/https:--assets.leetcode.com-uploads-2021-12-14-ex2.png" style="width: 219px; height: 220px;"></p>
