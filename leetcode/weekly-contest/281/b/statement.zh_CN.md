...
??? info "Metadata"
    - Link: [合并零之间的节点](https://leetcode-cn.com/problems/merge-nodes-in-between-zeros)
    - Difficulty: Medium
    - Tag: 
...
<p><strong>示例 1：<br />
<img alt="" src="problem-assets/https:--assets.leetcode.com-uploads-2022-02-02-ex1-1.png" style="width: 600px; height: 41px;" /></strong></p>
...
<p><strong>示例 2：<br />
<img alt="" src="problem-assets/https:--assets.leetcode.com-uploads-2022-02-02-ex2-1.png" style="width: 600px; height: 41px;" /></strong></p>
