...
??? info "Metadata"
    - Link: [Display Table of Food Orders in a Restaurant](https://leetcode.com/problems/display-table-of-food-orders-in-a-restaurant)
    - Difficulty: Medium
    - Tag: `Array` `Hash Table` `String` `Ordered Set` `Sorting`
