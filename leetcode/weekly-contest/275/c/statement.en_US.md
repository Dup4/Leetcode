...
??? info "Metadata"
    - Link: [Count Words Obtained After Adding a Letter](https://leetcode.com/problems/count-words-obtained-after-adding-a-letter)
    - Difficulty: Medium
    - Tag: `Bit Manipulation` `Array` `Hash Table` `String` `Sorting`
